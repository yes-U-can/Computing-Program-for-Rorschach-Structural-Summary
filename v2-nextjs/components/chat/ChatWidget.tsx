      ...
      <div className="p-4 border-t border-slate-200 bg-white sm:rounded-b-2xl">
        <form onSubmit={handleSendMessage} className="flex items-center gap-2">
          <input
            ...
            className="flex-1 w-full px-4 py-2.5 text-sm rounded-xl bg-slate-100 border-transparent focus:bg-white focus:border-sky-500 focus:ring-1 focus:ring-sky-500 transition"
          />
          <button
            type="submit"
            className="p-3 bg-sky-600 text-white rounded-xl shadow-sm hover:bg-sky-700 disabled:opacity-50"
