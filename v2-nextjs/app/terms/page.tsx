    ...
    sections: [
      {
        ...
        items: [
          ...
          '회원이란 Google OAuth를 통해 로그인하여 계정을 생성하고 서비스를 이용하는 자를 말합니다.',
      ...
      },
      {
        ...
        items: [
          ...
          '이용자는 개정 약관에 동의하지 않을 경우, 시행일 전까지 운영자에게 이의제기를 하고 서비스 이용을 중단(회원은 탈퇴 포함)할 수 있습니다.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '2. El Miembro es responsable de la gestión y seguridad de su cuenta.',
          '3. El Operador podrá suspender o cancelar la cuenta en los siguientes casos:',
          ...
          '4. El Miembro podrá presentar una reclamación respecto a cualquier medida adoptada, y el Operador revisará el caso en un plazo razonable.',
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '2. O Membro é responsável pela gestão e segurança de sua conta.',
          '3. A Operadora poderá suspender ou encerrar a conta nos seguintes casos:',
          ...
          '4. O Membro poderá apresentar contestação às medidas adotadas, e a Operadora analisará o caso em prazo razoável.',
        ],
      },
      {
